...
the URL `http://<target-server>:8080/MAAS/`.  Username is
`cord`, the password is autogenerated and can be found in file '~/cord/build/maas/passwords/maas_user.txt'.  For more information on MaaS, see [the MaaS
